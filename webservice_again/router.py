...
from webservice_again.viewset import MySnippetViewSet, RegistrationViewset, CheckUserExistence, LoginViewSet, \
    AddVoterViewSet, GetVoterByUserType, UpdateVoter
...
# myRouters.register('updateVoter', UpdateVoter, base_name='updateVoter')

# Testing
myRouters.register('getVisitorList', ListRetrieveViewSet, base_name='getVisitorList')
